...
<table border="0" style="width:100%;font-size:14px;" id="add_defensedepot_form" name="add_defensedepot_form">
<tbody>
<tr><td>E-mail</td><td>:</td><td><input type="email" name="email" id="email" class="form-control" required="on" placeholder="Entrer votre email" style="width:100%;" value="<?php echo $email;?>"></td></tr>
